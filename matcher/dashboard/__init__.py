...
blueprint.add_url_rule('/', methods=['GET', 'POST'], view_func=views.home.HomeView.as_view('home'))

blueprint.add_url_rule('/scraps', view_func=views.scraps.ScrapListView.as_view('scrap_list'))
blueprint.add_url_rule('/scraps/<int:id>',
...
blueprint.add_url_rule('/exports/', view_func=views.exports.ExportIndexView.as_view('exports'))
...
blueprint.add_url_rule('/exports/files/<int:id>/delete',
