...
class Platform(Base):
    ...
    id = Column(
        Integer,
        platform_id_seq,
        server_default=platform_id_seq.next_value(),
        primary_key=True,
    )
    name = Column(Text, nullable=False)
...
class Scrap(Base):
    ...
    sessions = relationship(
        "Session", secondary="session_scrap", back_populates="scraps"
    )
...
class Session(Base):
    ...
    id = Column(
        Integer,
        session_id_seq,
        server_default=session_id_seq.next_value(),
        primary_key=True,
    )
    ...
    imports = relationship(
        "ImportFile", secondary="session_import_file", back_populates="sessions"
    )
