...
def upgrade():
    ...
    op.create_foreign_key('value_source_platform_id_fkey', 'value_source', 'platform', ['platform_id'], ['id'])
    op.create_foreign_key('value_source_value_id_fkey', 'value_source', 'value', ['value_id'], ['id'])
...
def downgrade():
    ...
    op.create_foreign_key('value_source_id_platform_fkey', 'value_source', 'platform', ['id_platform'], ['id'])
    op.create_foreign_key('value_source_id_value_fkey', 'value_source', 'value', ['id_value'], ['id'])
