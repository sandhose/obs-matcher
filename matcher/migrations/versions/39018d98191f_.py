...
def upgrade():
    op.add_column('platform', sa.Column('allow_links_overlap', sa.Boolean(), server_default="FALSE", nullable=False))
    op.add_column('platform', sa.Column('ignore_in_exports', sa.Boolean(), server_default="FALSE", nullable=False))
